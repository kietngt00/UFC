...
def main(args):
    ...
    logger = TensorBoardLogger("DiT_tuning_logs", name=f"{base_name}_{ckpt_ep}_{args.task}_{args.shots}_{args.exp_name}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task_ckpt_path", type=str)
