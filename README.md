...
| `Canny` | [UNet_canny_30](https://huggingface.co/ntk1507/UFC/tree/main/unet_tuning_logs/UNet_taskgr23_canny_30) | [UNet_taskgr23](https://huggingface.co/ntk1507/UFC/tree/main/unet_logs/UNet_taskgr23) | <div align="center">The base model is trained with 4 tasks: `[Depth, Normal, Pose, Densepose]`</div> |
